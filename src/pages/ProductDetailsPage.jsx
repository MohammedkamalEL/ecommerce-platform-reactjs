      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm">
          <img
            ...
            alt={product.title}
            className="w-full aspect-square object-cover h-full bg-cover"
          />
        </div>
            ...
            <div className="space-y-8">
              {reviews.length > 0 ? (
                reviews.map((review) => (
                  <div
                    key={review.id}
                    className="bg-gray-50 rounded-2xl p-6 transition-hover  hover:shadow-sm border border-transparent hover:border-gray-100"
                  >
